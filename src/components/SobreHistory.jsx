...
const SobreHistory = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 items-center px-3 py-5 md:flex">
      <div className="w-full max-w-full md:max-w-[700px] mx-auto mb-[45px] md:mb-0 py-5 px-5">
        <h3 className="green-titile text-center text-sm md:text-2xl lg:text-left">
