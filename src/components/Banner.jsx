    ...
    <>
      ...
      >
        ...
        <img
          src={logo}
          alt="logo"
          className="w-20 sm:w-55 2xl:w-[230px] absolute left-[10px] top-[calc(50%-45px)] md:left-[60px] md:top-[calc(50%-70px)]  lg:top-[185px] xl:left-[120px] xl:top-[185px] 2xl:left-[220px] 2xl:top-[185px]"
        />
        <img
          src={appleSliceV1}
          alt="appleSliceV1"
