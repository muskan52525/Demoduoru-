    ...
    <>
      ...
      {topRight && (
        <img
          src={topRight}
          alt=""
          className="pointer-events-none select-none  hidden lg:block absolute top-0 right-0 h-[160px] w-[230px] mt-[30px]"
        />
      )}
      ...
      {bottomLeft && (
        <img
          src={bottomLeft}
          alt=""
          className="pointer-events-none select-none hidden lg:block absolute bottom-0 left-0 h-[150px] w-[170px] mb-[20px]"
        />
      )}
    </>
  );
